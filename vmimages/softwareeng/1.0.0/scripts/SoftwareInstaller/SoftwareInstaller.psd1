#
# Module manifest for module 'SoftwareInstaller'
#
# Generated by: Azure TRE Team
#
...
FunctionsToExport = @('Get-StorageAccessToken', 'Download-SoftwareFromStorage', 'Install-Software', 'Install-SoftwareFromStorage')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = @'
Version 1.0.0:
- Initial release of SoftwareInstaller module
- Support for downloading software from Azure Storage using managed identity
- Support for silent software installation with custom arguments
- Comprehensive error handling and logging
- Designed for Azure TRE VM image provisioning scenarios
'@
