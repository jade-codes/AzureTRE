# Rules found here: https://github.com/Azure/prometheus-collector/tree/main/AddonTerraformTemplate
resource "azurerm_monitor_alert_prometheus_rule_group" "node_recording_rules_rule_group" {
  ...
  interval            = "PT1M"
  scopes              = [data.azurerm_monitor_workspace.amw.id, data.azurerm_kubernetes_cluster.aks.id]
